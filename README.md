...
![Solved 7-seg level: wired NOT/OR gates, live seven-segment display, passing truth table](docs/gameplay.png)

*Screenshot generated by `e2e/screenshot.spec.js` — re-run with `npx playwright test e2e/screenshot.spec.js`.*
